...
class Student_Teacher:
    def __init__(self,root):#calling constructor(root(window name))
       ...
       # self.root.wm.iconbitmap("icon.ico")
        ...
        studentId_entry=ttk.Entry(class_student_frame,textvariable=self.var_dob,width=20,font=("times new roman",13,"bold"))
    ...
    #------------------------phone number------------------------
        ...
        radiobutton2.grid(row=7,column=1,padx=30,pady=10)
    ...
    #===========================save====================
        ...
        btn_frame1.place(x=0,y=250,width=920,height=70)
        #==================take photo sample================
        save_btn=Button(btn_frame1,text="Take Photo Sample",command=self.gen_dataset,width=34,font=("times new roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=1,column=0)
        #====================update photo sample================
        save_btn=Button(btn_frame1,text="Update Photo Sample",width=34,font=("times new roman",13,"bold"),bg="blue",fg="white")
...
#======================================RIGHT FRAME==============================
    ...
    #===========================scroll bar======================
        ...
        self.teacherstudent_table=ttk.Treeview(table_frame,columns=("Department","Course","Year","Semester","Stu_id","Stu_name","Division","Roll_no.","Gender","DOB","E-mail","Phone","Address","Teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        scroll_x.pack(side=BOTTOM,fill=X)
        scroll_y.pack(side=RIGHT,fill=Y)
        scroll_x.config(command=self.teacherstudent_table.xview)
        scroll_y.config(command=self.teacherstudent_table.yview)
        

        self.teacherstudent_table.heading("Department",text="Department")
        self.teacherstudent_table.heading("Course",text="Course")
        self.teacherstudent_table.heading("Year",text="Year")
        self.teacherstudent_table.heading("Semester",text="Semester")
        self.teacherstudent_table.heading("Stu_id",text="Stu_id")
        self.teacherstudent_table.heading("Stu_name",text="Stu_name")
        self.teacherstudent_table.heading("Division",text="Division")
        self.teacherstudent_table.heading("Roll_no.",text="Roll_number")
        self.teacherstudent_table.heading("Gender",text="Gender")
        self.teacherstudent_table.heading("DOB",text="DOB")
        self.teacherstudent_table.heading("E-mail",text="E-mail")
        self.teacherstudent_table.heading("Phone",text="Phone")
        self.teacherstudent_table.heading("Address",text="Address")
        self.teacherstudent_table.heading("Teacher",text="Teacher")
        #self.teacherstudent_table.heading("photosample",text="photosample")

        self.teacherstudent_table["show"]="headings"

        self.teacherstudent_table.pack(fill=BOTH,expand=1)

        #-------------------To set width-----------------
        self.teacherstudent_table.column("Department",width=100)
        self.teacherstudent_table.column("Course",width=100)
        self.teacherstudent_table.column("Year",width=100)
        self.teacherstudent_table.column("Semester",width=100)
        self.teacherstudent_table.column("Stu_id",width=100)
        self.teacherstudent_table.column("Stu_name",width=100)
        self.teacherstudent_table.column("Division",width=100)
        self.teacherstudent_table.column("Roll_no.",width=100)
        self.teacherstudent_table.column("Gender",width=100)
        self.teacherstudent_table.column("DOB",width=100)
        self.teacherstudent_table.column("E-mail",width=100)
        self.teacherstudent_table.column("Phone",width=100)
        self.teacherstudent_table.column("Address",width=100)
        self.teacherstudent_table.column("Teacher",width=100)
        self.teacherstudent_table.column("photo",width=100)

        self.teacherstudent_table.pack(fill=BOTH,expand=1)
        self.teacherstudent_table.bind("<ButtonRelease>",self.get_cursor)
        self.fetch_data()
        ...
        if self.var_dep.get()=="Select Department" or self.var_stu_id.get()=='' or self.var_stu_name.get()=='':
            messagebox.showerror("Error","All field Are required",parent=self.root)
             ...
             try:
                ...
                my_cursor.execute("insert into teacherstudent values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
    ...
    def fetch_data(self):
         ...
         if len(data)!=0:
             self.teacherstudent_table.delete(*self.teacherstudent_table.get_children())
             for i in data:
                 self.teacherstudent_table.insert("",END,values=i)
             conn.commit()
         conn.close()    
#=======================get cursor======================
    def get_cursor(self,event=""):
        cursor_focus=self.teacherstudent_table.focus()
        content=self.teacherstudent_table.item(cursor_focus)
        data=content["values"]
...
if __name__ == '__main__':#main
    ...
    obj=Student_Teacher(root)#making class object
